...
final bigHeaderTextStyle = baseTextStyle.copyWith(
    fontSize: 24.0,
    fontWeight: FontWeight.bold); // bigheader untuk judul nama product
final descTextStyle =
    baseTextStyle.copyWith(fontSize: 16.0, fontWeight: FontWeight.w300);
  ...
  topContent(String arab, String arti) {
    return new Container(
      child: Column(
        ...
        mainAxisAlignment: MainAxisAlignment.center, //agar seimbang
